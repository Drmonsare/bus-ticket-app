...
const BusTicketSystem = () => {
  ...
  const calculateDiscountedFare = (originalFare) => {
    if (!originalFare || isNaN(parseFloat(originalFare))) return '0.00';
        ...
        <div className="bg-white rounded-lg p-6 mx-auto max-w-md shadow-lg">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-xl font-semibold">₹{parseFloat(ticketData.fare).toFixed(2)}</div>
            </div>
          </div>
          ...
          <div className="text-center mb-4">
            <div className="text-base font-mono text-gray-500">{transactionId}</div>
          </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50" onClick={() => setShowQRModal(false)}>
            <div className="bg-white rounded-lg p-8 max-w-sm mx-4" onClick={(e) => e.stopPropagation()}>
              ...
              <button
                ...
                className="w-full bg-blue-500 text-white py-2 mt-4 rounded-lg hover:bg-blue-600 transition-colors"
              >
                Close
              </button>
            </div>
